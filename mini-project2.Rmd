...
```{r}
# drop pool.qc, misc.feature, alley, fence, fireplace.qu, and lot.frontage because most of that data is missing
data <- data[,-c(5,8,58,73,74,75)]
md.pattern(data, rotate.names=TRUE)

which(is.na(data$Bsmt.Full.Bath))
which(is.na(data$Garage.Area))
