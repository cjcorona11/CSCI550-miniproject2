...
```{r}
plot(data$Year.Built, data$price, main="Price vs. Year Built Fit with 2nd Order Polynomial", xlab="Year Built", ylab="Price")
x <- seq(1872, 2010, 1)
xNew <- tibble(Year.Built = x, 
               Year.Built2 = x^2)
y <- predict(m2, newdata=xNew)
lines(x, y, col="red")
```
Figure : Plot of price vs year built, fit of 2nd order polynomial shown in red.
